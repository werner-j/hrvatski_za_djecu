...
\begin{itemize}
    \item \path{audio/pronunciation/letters/} - Einzelne Buchstabenlaute
    \item \path{audio/pronunciation/words/} - Übungswörter
    \item \path{audio/pronunciation/sentences/} - Beispielsätze
\end{itemize}
...
Audio: \path{sentences/covjek\_pije\_caj.mp3}
...
Audio: \path{sentences/macka\_spava.mp3}
...
Audio: \path{sentences/skola\_ima\_sumu.mp3}
...
Audio: \path{sentences/zena\_gleda\_zabu.mp3}
...
Audio: \path{sentences/dzem\_u\_dzepu.mp3}
...
Audio: \path{sentences/djak\_rodjendan.mp3}
...
Audio: \path{sentences/cura\_cvijet.mp3}
...
Audio: \path{sentences/ljudi\_ljeto.mp3}
...
Audio: \path{sentences/konj\_knjiga.mp3}
...
Audio: \path{words/syllabic\_r\_examples.mp3}
...
Audio: \path{sentences/hrvatski\_jezik.mp3}
...
Audio: \path{words/vowel\_examples.mp3}
...
Audio: \path{exercises/exercise1\_special\_letters.mp3}
...
Audio: \path{exercises/exercise2\_minimal\_pairs.mp3}
...
Audio: \path{exercises/exercise3\_syllabic\_r.mp3}
...
Audio: \path{exercises/exercise5\_sentences.mp3}
