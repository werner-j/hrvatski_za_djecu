...
\usepackage{fontspec}
% Note: Using only 'german' for babel as the document is primarily in German
% with Croatian words embedded. The 'croatian' option is not needed and
% causes compatibility issues with some LaTeX distributions.
...
% URL package for better path handling
\usepackage{url}
